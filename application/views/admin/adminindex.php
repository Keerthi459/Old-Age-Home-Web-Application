...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="<?php base_url();?>images\old2.jpg" alt="">
        <div class="text">
<br>
<br>
          <span class="text-1">Seva Sangam Trust <br>Old Age Home</span>
        ...
        <div class="login-form">
          ...
          <form action="" name="login" method="post">
            <div class="input-boxes">
              ...
              <div class="error1" id="err_hide" style="color: red;text-align: center;"><?php echo $this->session->flashdata("ErrMsg"); ?></div>
