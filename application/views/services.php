...
<div class="container">
   ...
   <div class="products-container">
      ...
      <div class="product" data-name="p-1">
         <img src="<?php echo base_url(); ?>images/1/1.png" alt="">
         <h3>Medical Support</h3>
      </div>

      <div class="product" data-name="p-2">
         <img src="<?php echo base_url(); ?>images/1//2.png" alt="">
         <h3>Transport</h3>
      </div>

      <div class="product" data-name="p-3">
         <img src="<?php echo base_url(); ?>images/1//3.png" alt="">
         <h3>Activities</h3>
      </div>

      <div class="product" data-name="p-4">
         <img src="<?php echo base_url(); ?>images/1//4.png" alt="">
         <h3>Members</h3>
      </div>

      <div class="product" data-name="p-5">
         <img src="<?php echo base_url(); ?>images/1//5.png" alt="">
         <h3>Facility</h3>
      </div>

      <div class="product" data-name="p-6">
         <img src="<?php echo base_url(); ?>images/1//6.png" alt="">
         <h3>Amenities</h3>
       </div>
